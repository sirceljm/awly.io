...
var button = require("src/components/vendor/markojs/app-button");
var checkbox = require("src/components/vendor/markojs/app-checkbox");
var progressBar = require("src/components/vendor/markojs/app-progress-bar");
